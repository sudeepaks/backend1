...
const registerUser = asyncHandler( async (req, res) => {
    ...
    if (existedUser) {
        throw new ApiError(409, "User eith email or username already exists")
    }
    ...
    if (!avatarLocalPath) {
        throw new ApiError(400, "AvatarLocal")
    }
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    const incomingRefreshToken = req.coookie.refreshToken || req.body.refreshToken
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, user, "avathar image updated succesflly")
    )
})
